...
from src.tf.ea_models.aligne import AlignE
...
class BootEA(AlignE):
    ...
    def _define_alignment_graph(self):
        ...
        self.alignment_optimizer = generate_optimizer_tf(self.alignment_loss, self.args.learning_rate,
    ...
    def _define_likelihood_graph(self):
        ...
        self.likelihood_optimizer = generate_optimizer_tf(self.likelihood_loss, self.args.learning_rate,
                                                       opt=self.args.optimizer)
    ...
    def run(self):
        ...
        for i in range(1, iter_nums + 1):
            ...
            neighbors1 = batch.generate_neighbours_single_thread(self.eval_kg1_useful_ent_embeddings(),
                                                               self.kgs.useful_entities_list1,
                                                               neighbors_num1, self.args.test_threads_num)
            neighbors2 = batch.generate_neighbours_single_thread(self.eval_kg2_useful_ent_embeddings(),
                                                               self.kgs.useful_entities_list2,
