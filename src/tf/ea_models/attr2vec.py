...
from src.py.base.initializers import xavier_init
...
from src.py.util.util import merge_dic, generate_out_folder, load_session
...
class Attr2Vec:
    ...
    def _define_embed_graph(self):
        ...
        with tf.name_scope('attribute_nce_loss'):
            ...
            self.optimizer = generate_optimizer_tf(self.loss, self.args.learning_rate, opt=self.opt)
