...
from src.py.base.mapping import add_mapping_variables, add_mapping_module
...
class BasicModel:
    ...
    def save(self):
        ...
        read.save_embeddings(self.out_folder, self.kgs, ent_embeds, rel_embeds, None, mapping_mat=mapping_mat)
