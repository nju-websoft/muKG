...
from src.py.base.initializers import init_embeddings, orthogonal_init
...
class SEA(BasicModel):
    ...
    def _define_embed_graph(self):
        ...
        with tf.name_scope('semi_sup_mapping_loss'):
            ...
            self.mapping_optimizer = generate_optimizer_tf(self.mapping_loss, self.args.learning_rate,
                                                        opt=self.args.optimizer)
