...
from src.py.evaluation.alignment_finder import find_potential_alignment_greedily
...
class IPTransE(BasicModel):
    ...
    def _define_embed_graph(self):
        ...
        self.train_loss = self._generate_loss(phs, prs, pts, nhs, nrs, nts, prx, pry, pr, nrx, nry, nr,
                                              self.path_weight)
        self.optimizer = generate_optimizer_tf(self.train_loss, self.args.learning_rate, opt=self.args.optimizer)
